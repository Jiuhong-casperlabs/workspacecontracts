...
pub const DICTIONARY_REF: &str = "dictname";
pub const DEFAULT_DICTIONARY_NAME: &str = "abcname";
pub const DEFAULT_DICTIONARY_VALUE: &str = "abcvalue";
...
pub extern "C" fn test() {
    ...
    runtime::put_key("dicvalue", storage::new_uref(value).into());
}
